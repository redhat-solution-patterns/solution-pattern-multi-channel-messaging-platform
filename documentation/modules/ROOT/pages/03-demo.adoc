...
++++
<p align="center">
	<img src="_images/31-demo-extend-platform-request-flow.png" alt="Data flow pushing messages to AMQ" width="50%">
</p>
++++
...
++++
<p align="center">
	<img src="_images/32-demo-extend-platform-response-flow.png" alt="Data flow consuming messages from AMQ" width="50%">
</p>
++++
...
// .Partner integration
image:34-demo-partner-support.png[,40%, align=left]
...
image::35-demo-terminal-open.png[,90%, align=center]
