...
`[DodgerBlue-background]#Sign in#`

`[#1E90FF-background]#Sign in#`


`pass:[<mark style="background-color: dodgerblue; color: white">Sign In</mark>]`

`[white DodgerBlue-background]#Sign in#`

[blue]`#Sign in#`

To open _Matrix_, click _Element_'s route link and then click `[blue-background]#Sign in#` as shown below:
