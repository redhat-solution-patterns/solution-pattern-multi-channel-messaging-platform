...
// ++++
// <p align="center">
// 	<img src="_images/01-scenario-problem.png" alt="Scenario problem" width="40%">
// </p>
// ++++
// endif::env-vscode,env-github[]
...
//When rendering in VS-Code or GitHub
ifdef::env-vscode,env-github[]
image::02-scenario-solution.png[width=40%, align=center]
endif::env-vscode,env-github[]
...
++++
<p align="center">
	<img src="_images/02-scenario-solution.png" alt="Scenario solution" width="40%">
</p>
++++
endif::env-vscode,env-github[]
...
// // image::03-architecture-high-level.png[width=70%, align=center]
