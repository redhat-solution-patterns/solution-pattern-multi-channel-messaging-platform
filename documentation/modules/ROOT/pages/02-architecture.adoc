...
++++
<p align="center">
	<img src="_images/05-scalability-target.png" alt="Scaling outbound traffic" width="60%">
</p>
++++
endif::env-vscode,env-github[]
...
++++
<p align="center">
	<img src="_images/07-arch-decoupling.png" alt="Decoupled architecture" width="40%">
</p>
++++
endif::env-vscode,env-github[]
...
image::08-arch-common-schema.png[,90%,align=center]
endif::env-vscode,env-github[]
...
++++
<p align="center">
	<img src="_images/08-arch-common-schema.png" alt="Common Schema for data exchanges" width="90%">
</p>
++++
endif::env-vscode,env-github[]
